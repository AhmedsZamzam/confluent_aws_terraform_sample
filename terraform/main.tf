...
resource "confluent_environment" "staging" {
  display_name = "cflt-demo-${random_id.env_display_id.hex}"
}
...
resource "confluent_service_account" "app-consumer" {
  display_name = "app-consumer-${random_id.env_display_id.hex}"
...
resource "confluent_connector" "mongo-db-sink" {
  ...
  config_nonsensitive = {
    ...
    "kafka.service.account.id" = confluent_service_account.app-consumer.id
    "connection.host"          = var.mongodb_endpoint
